// Package testutil provides reusable test doubles shared across packages.
package testutil
...
var _ discovery.IndexRepository = (*IndexRepository)(nil)

func NewIndexRepository() *IndexRepository {
	return &IndexRepository{}
}

func (r *IndexRepository) ReplaceDomain(
	ctx context.Context,
	domain model.Domain,
	entries []model.DiscoveryIndexEntry,
) error {
